...
namespace _584_bb_proj;

public class JwtHandler (IConfiguration configuration, UserManager<BaseballTeamsUser> userManager)
{
    public async Task<JwtSecurityToken> GetTokenAsync(BaseballTeamsUser user) =>
        new(
    ...
    private async Task<List<Claim>> GetClaimsAsync(BaseballTeamsUser user)
    {
